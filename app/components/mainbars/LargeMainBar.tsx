        ...
        {navItems.map((item, index) => {
          ...
          return (
            ...
            >
              <Link
                href={item.href}
                className={`group relative flex items-center gap-4 rounded-xl px-4 py-3 transition-all duration-300 overflow-hidden
                  
                  ${
                    isActive
                      ? 'bg-cyan-400/10 text-white border border-cyan-400/10'
              ...
              >
                ...
                {/* Left Accent */}
                <div
                  className={`relative z-10 h-8 w-[3px] rounded-full transition-all duration-300
                    ${
                      isActive
                        ? 'bg-cyan-400'
                ...
                {/* Text */}
                <span
                  className={`relative z-10 text-[15px] font-medium tracking-wide transition-all duration-300
                    ${
                      isActive
                        ? 'text-white'
